...
must_haves:
  truths:
    - "Phone numbers in transcripts are NOT falsely redacted as [ROOM]"
    - "Date components (January 11, December 25) are NOT falsely redacted as [ROOM]"
    - "Time components (08:46, 14:30) are NOT falsely redacted as [ROOM]"
    - "Street addresses (6247 Hickman Cliffs) are NOT falsely redacted as [ROOM]"
    - "List markers (1) GI consult, 2) Labs) are NOT falsely redacted as [ROOM]"
    - "ROOM precision >= 40% on evaluation dataset (up from 17%)"
  artifacts:
